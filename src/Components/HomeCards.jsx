...
const HomeCards = () => {
  return (
    <div className='w-[95%] sm:w-[90%] md:w-[95%] lg:w-[80%] xl:w-[60%] grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-0 lg:gap-2 h-full mx-auto relative mt-32 font-thin'>
        <div className=' md:w-[90%] h-full m-4 bg-red-700'>
            <div className='w-full h-[150px] bg-gradient-to-b from-red-600 to-red-500 flex flex-col items-center justify-center'>
                ...
                <Link to='/our-policies'>
                    <p className='text-white uppercase font-semibold text-lg text-center'>Warranty Assured</p>
                </Link>
            </div>
            <div className='w-full h-[100px] md:h-[190px] xl:h-[140px] flex items-center justify-center'>
                <p className='text-white/80 mx-5 text-center font-semibold text-sm sm:text-lg md:text-sm'>
        ...
        <div className=' md:w-[90%] h-full m-4 bg-red-700'>
            <div className='w-full h-[150px] bg-gradient-to-b from-red-600 to-red-500 flex flex-col items-center justify-center'>
                ...
                <Link to='/home-delivery'>
                    <p className='text-white uppercase font-semibold text-lg text-center'>home delivery</p>
                </Link>
            </div>
            <div className='w-full h-[100px] md:h-[190px] xl:h-[140px] flex items-center justify-center'>
                <p className='text-white/80 mx-5 text-center font-semibold text-sm sm:text-lg md:text-sm'>
        ...
        <div className=' md:w-[90%] h-full m-4 bg-red-700'>
            <div className='w-full h-[150px] bg-gradient-to-b from-red-600 to-red-500 flex flex-col items-center justify-center'>
                ...
                <Link to='/service-center'>
                    <p className='text-white uppercase font-semibold text-lg text-center'>Service center</p>
                </Link>
            </div>
            <div className='w-full h-[100px] md:h-[190px] xl:h-[140px] flex items-center justify-center'>
                <p className='text-white/80 mx-5 text-center font-semibold text-sm sm:text-lg md:text-sm'>
