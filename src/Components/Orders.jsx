...
const Orders = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      const api = "https://admin.senex.lk/Api/Order?CustomerID=";
  ...
  if (orders.length === 0) {
    return (
      <div className="text-white h-[95vh] pt-28 w-[80%] mx-auto relative">
  ...
  return (
    <div className="w-[90%] md:min-h-[700px] lg:min-h-[650px] xl:min-h-[700px] 2xl:min-h-[800px] relative mx-auto px-4 py-8 mb-5">
      <h1 className="text-2xl font-bold mb-5 text-white font-poppins">
        Track My Orders
      </h1>
          ...
          <tbody>
            {orders.map((order) => (
              <tr key={order.orderID}>
                ...
                <td className="px-4 py-2 border-b border-gray-200 font-poppins">
                  {order.itemTotalDisplay}
                </td>
                <td
                  className={`px-4 py-2 border-b border-gray-200 font-poppins ${
                    order.orderStatusClass === "success"
                      ? "text-green-500"
                      : "text-red-500"
                  }`}
                >
